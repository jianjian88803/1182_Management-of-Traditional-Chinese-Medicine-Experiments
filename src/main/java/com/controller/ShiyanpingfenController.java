...
public class ShiyanpingfenController {
    ...
    public R page(@RequestParam Map<String, Object> params,ShiyanpingfenEntity shiyanpingfen,
		...
		if(tableName.equals("xuesheng")) {
			shiyanpingfen.setXuehao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiaoshi")) {
			shiyanpingfen.setGonghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ShiyanpingfenEntity> wrapper = new EntityWrapper<ShiyanpingfenEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = shiyanpingfenService.selectCount(wrapper);
