    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="指导内容" prop="zhidaoneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="指导内容"
                  v-model="ruleForm.zhidaoneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhidaoneirong" label="指导内容" prop="zhidaoneirong">
                    <span>{{ruleForm.zhidaoneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaoshixingming = true;
          ...
          if(o=='zhidaoneirong'){
            this.ruleForm.zhidaoneirong = obj[o];
	    this.ro.zhidaoneirong = true;
            continue;
          }
          if(o=='shiyanriqi'){
