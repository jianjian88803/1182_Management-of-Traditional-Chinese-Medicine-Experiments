...
export default {
  ...
  methods: {
	...
	this.ruleForm.jiaoxueneirong = this.ruleForm.jiaoxueneirong.replace(reg,'../../../springboot3n829/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shiyanjiaoxue/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shiyanjiaoxueCrossAddOrUpdateFlag = false;
                  this.parent.search();
