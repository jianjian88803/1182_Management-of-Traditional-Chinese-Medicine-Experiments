    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="器材用法" prop="qicaiyongfa">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="器材用法"
                  v-model="ruleForm.qicaiyongfa" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qicaiyongfa" label="器材用法" prop="qicaiyongfa">
                    <span>{{ruleForm.qicaiyongfa}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhuyishixiang = true;
          ...
          if(o=='qicaiyongfa'){
            this.ruleForm.qicaiyongfa = obj[o];
	    this.ro.qicaiyongfa = true;
            continue;
          }
        }
      }
