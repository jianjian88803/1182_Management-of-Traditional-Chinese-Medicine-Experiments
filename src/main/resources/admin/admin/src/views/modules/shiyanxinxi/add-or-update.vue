<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实验类型" prop="shiyanleixing">
          <el-input v-model="ruleForm.shiyanleixing" 
              placeholder="实验类型" clearable  :readonly="ro.shiyanleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实验类型" prop="shiyanleixing">
              <el-input v-model="ruleForm.shiyanleixing" 
                placeholder="实验类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实验地点" prop="shiyandidian">
          <el-input v-model="ruleForm.shiyandidian" 
              placeholder="实验地点" clearable  :readonly="ro.shiyandidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实验地点" prop="shiyandidian">
              <el-input v-model="ruleForm.shiyandidian" 
                placeholder="实验地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="实验时间" prop="shiyanshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.shiyanshijian" 
                type="date"
                placeholder="实验时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shiyanshijian" label="实验时间" prop="shiyanshijian">
              <el-input v-model="ruleForm.shiyanshijian" 
                placeholder="实验时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  data() {
	...
	shiyanneirong : false,
      ...
      rules: {
          ...
          shiyanleixing: [
                { required: true, message: '实验类型不能为空', trigger: 'blur' },
          ],
          tupian: [
          ],
          shiyandidian: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shiyanmingcheng = true;
          ...
          if(o=='shiyanleixing'){
            this.ruleForm.shiyanleixing = obj[o];
	    this.ro.shiyanleixing = true;
            continue;
          }
          if(o=='tupian'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='shiyandidian'){
            this.ruleForm.shiyandidian = obj[o];
	    this.ro.shiyandidian = true;
            continue;
          }
          if(o=='shiyanshijian'){
            this.ruleForm.shiyanshijian = obj[o];
	    this.ro.shiyanshijian = true;
            continue;
          }
          if(o=='gonghao'){
